      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 max-w-5xl mx-auto">
          ...
          <div className="lg:col-span-5 flex flex-col gap-6 justify-center">
            <h3 className="text-xl font-bold text-slate-800 dark:text-white mb-2 text-left">
              Contact Details
            </h3>
            
            <p className="text-sm sm:text-base text-slate-600 dark:text-slate-400 leading-relaxed mb-6 text-left">
            ...
            <div className="space-y-4">
              {contactInfo.map((info) => (
                <a
                  ...
                  className="flex items-center gap-4 p-5 rounded-2xl glass-card-light dark:glass-card-dark border border-slate-200/20 dark:border-white/10 shadow-lg hover:translate-y-[-3px] hover:shadow-neon-indigo/5 transition-all duration-300 group"
                >
                  <div className="w-10 h-10 rounded-xl bg-slate-500/5 dark:bg-white/5 border border-slate-200/10 dark:border-white/5 flex items-center justify-center group-hover:bg-gradient-to-tr group-hover:from-cyan-500 group-hover:to-indigo-500 group-hover:text-white transition-colors duration-300 shadow-sm">
                    {info.icon}
                  </div>
          ...
          <div className="lg:col-span-7">
            <form
              ...
              className="p-6 sm:p-8 rounded-2xl glass-card-light dark:glass-card-dark border border-slate-200/20 dark:border-white/10 shadow-xl relative"
            >
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-5">
                {/* Name */}
                <div className="text-left">
                  <label htmlFor="name" className="block text-xs font-bold text-slate-600 dark:text-slate-300 uppercase tracking-wider mb-2">
                    Name
                  </label>
                  <input
                    type="text"
                    ...
                    className={`w-full px-4 py-3 rounded-xl bg-slate-500/5 dark:bg-white/5 border text-sm text-slate-700 dark:text-slate-100 placeholder-slate-400 focus:outline-none focus:ring-1 focus:ring-cyan-400 focus:border-cyan-400 transition-all ${
                      errors.name ? 'border-red-500' : 'border-slate-200/20 dark:border-white/10'
                    }`}
                ...
                <div className="text-left">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className={`w-full px-4 py-3 rounded-xl bg-slate-500/5 dark:bg-white/5 border text-sm text-slate-700 dark:text-slate-100 placeholder-slate-400 focus:outline-none focus:ring-1 focus:ring-cyan-400 focus:border-cyan-400 transition-all ${
                      errors.email ? 'border-red-500' : 'border-slate-200/20 dark:border-white/10'
                    }`}
              ...
              <div className="mb-5 text-left">
                <label htmlFor="subject" className="block text-xs font-bold text-slate-600 dark:text-slate-300 uppercase tracking-wider mb-2">
                  Subject
                </label>
                <input
                  type="text"
                  ...
                  onChange={handleChange}
                  className={`w-full px-4 py-3 rounded-xl bg-slate-500/5 dark:bg-white/5 border text-sm text-slate-700 dark:text-slate-100 placeholder-slate-400 focus:outline-none focus:ring-1 focus:ring-cyan-400 focus:border-cyan-400 transition-all ${
                    errors.subject ? 'border-red-500' : 'border-slate-200/20 dark:border-white/10'
                  }`}
              ...
              <div className="mb-6 text-left">
                <label htmlFor="message" className="block text-xs font-bold text-slate-600 dark:text-slate-300 uppercase tracking-wider mb-2">
                  Message
                </label>
                <textarea
                  id="message"
                  ...
                  onChange={handleChange}
                  className={`w-full px-4 py-3 rounded-xl bg-slate-500/5 dark:bg-white/5 border text-sm text-slate-700 dark:text-slate-100 placeholder-slate-400 focus:outline-none focus:ring-1 focus:ring-cyan-400 focus:border-cyan-400 transition-all ${
                    errors.message ? 'border-red-500' : 'border-slate-200/20 dark:border-white/10'
                  }`}
              ...
              <AnimatePresence>
                {submitStatus === 'success' && (
                  <motion.div
                    ...
                    exit={{ opacity: 0, y: 10 }}
                    className="absolute inset-0 bg-[#0a0620]/95 backdrop-blur-sm rounded-2xl flex flex-col items-center justify-center p-6 text-center z-20"
                  >
