        ...
        >
          {achievementsData.map((item) => (
            <motion.div
              ...
              className="p-6 sm:p-8 rounded-2xl glass-card-dark border border-white/10 shadow-lg hover:shadow-neon-indigo/5 transition-all duration-300 hover:translate-y-[-5px]"
            >
              {/* Badge Icon */}
              ...
              {/* Category */}
              <span className="text-[10px] sm:text-xs font-bold tracking-widest text-indigo-400 uppercase mb-2 block">
                {item.category}
              </span>
